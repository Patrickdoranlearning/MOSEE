...
function LoginForm() {
  ...
  const callbackUrl = searchParams.get('callbackUrl') || '/wealth-tree'
  ...
  // Show error from URL params (e.g. after a failed redirect-based login)
  useEffect(() => {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Success — do a full page navigation to ensure the session is picked up
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-600">Sign in to your Wealth Tree</p>
        </div>
